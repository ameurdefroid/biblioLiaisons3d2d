...
// LES2 : Il faudrait utiliser un f(x) = 0 pour extraire beta de la LES -> je l'impose (on pourrait chercher une linéarisation pour faire un peu mieux)
real beta = 30/360*2*pi ;
real theta6 = 0*10/360*2*pi ;
...
draw(project(shift(P)*plaque), CEC3) ;
...
liaisonPivot(Opp, b0.z, b0.y, CEC6, CEC0) ;
...
liaisonPivot(Z + (0,0,-2), b0.z, b0.y, CEC0, CEC9) ;
